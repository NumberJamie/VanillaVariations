...
public class CrystallizerRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<CrystallizerRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(VanillaVariations.MOD_ID,"crystallizing");

        @Override
        public CrystallizerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CrystallizerRecipe(id, output, inputs);
        }

        @Override
        public CrystallizerRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, CrystallizerRecipe recipe) {
