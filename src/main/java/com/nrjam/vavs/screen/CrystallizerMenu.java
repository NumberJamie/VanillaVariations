...
import com.nrjam.vavs.screen.slot.ResultSlot;
...
public class CrystallizerMenu extends AbstractContainerMenu {
    private final CrystallizerEntity blockEntity;
    ...
    public CrystallizerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(MenuTypes.CRYSTALLIZER_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((CrystallizerEntity) entity);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new ResultSlot(handler, 3, 134, 38));
        });
