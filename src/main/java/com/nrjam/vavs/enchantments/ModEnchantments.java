...
public class ModEnchantments {
    ...
    public static RegistryObject<Enchantment> SCORING = ENCHANTMENTS.register("scoring", () -> new Scorching(Enchantment.Rarity.RARE, EnchantmentCategory.ARMOR_FEET, EquipmentSlot.FEET));
