...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.AMARANTH_CROP.get(), this.createCropDrops(ModBlocks.AMARANTH_CROP.get(), ModItems.AMARANTH.get(), ModItems.AMARANTH_SEED.get(), lootitemcondition$builder3));
